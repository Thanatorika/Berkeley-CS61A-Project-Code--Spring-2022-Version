...
class Frame:
    ...
    def lookup(self, symbol):
        ...
        # BEGIN PROBLEM 1
        "*** YOUR CODE HERE ***"
        if symbol not in self.bindings.keys() and not self.parent:
            raise SchemeError('unknown identifier: {0}'.format(symbol))
        elif symbol in self.bindings.keys():
    ...
    def make_child_frame(self, formals, vals):
        ...
        arg1, arg2 = formals, vals
        while arg1 is not nil:
            child_frame.define(arg1.first, arg2.first)
            arg1, arg2 = arg1.rest, arg2.rest
